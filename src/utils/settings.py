...
class Settings:
    ...
    def _load_settings(self):
        """설정 파일을 로드합니다."""
        default_settings_path = get_resource_path(os.path.join("src", "config", "default_settings.json"))
        settings_path = get_resource_path(os.path.join("src", "config", "settings.json"))
        ...
        try:
            if os.path.exists(default_settings_path):
                ...
                raise FileNotFoundError("default_settings.json 파일이 없습니다.")
